...
if ($_GET["fu"]==6) {
    ...
    $routing_id="";
    $routing_koord="";
    if($_POST["submitbutton"]==$lang['flottealpha']['uebernehmen']){
        ...
        <form name="formular" id="formular"  method="post" action="flotte_alpha.php?fu=6&shid=<?php echo $shid; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>&sprache=<?php echo $_GET["sprache"]?>">
            <center><table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    }elseif($_POST["submitbutton"]==$lang['flottealpha']['loeschen']){
                        $point=$_POST["point"];
                    ...
                    }elseif($_POST["submitbutton"]==$lang['flottealpha']['neuerpunkt']){
                        $point=$_POST["point"]+1;
                        $points=$_POST["points"]+1;

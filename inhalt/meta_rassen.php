        ...
        <center>
            <table border="0" cellspacing="0" cellpadding="3">
                <tr>
                    ...
                    <td><? if ($attribute[0]>=1) { echo str_replace('{1}',$attribute[0]-35,$lang['metarassen']['grad']); } else { echo $lang['metarassen']['keine']; } ?></td>
                    <td style="color:#aaaaaa;"><?php echo $lang['metarassen']['minenproduktion']?></td>
                    <td><? echo str_replace('{1}',$attribute[2]*100,$lang['metarassen']['vh'])?></td>
                    <td style="color:#aaaaaa;"><?php echo $lang['metarassen']['bodenkampfangriff']?></td>
                    <td><? echo str_replace('{1}',$attribute[3]*100,$lang['metarassen']['vh'])?></td>
                ...
                <tr>
                    ...
                    <td><? echo str_replace('{1}',$attribute[1]*100,$lang['metarassen']['vh'])?></td>
                    <td style="color:#aaaaaa;"><?php echo $lang['metarassen']['fabrikproduktion']?></td>
                    <td><? echo str_replace('{1}',$attribute[5]*100,$lang['metarassen']['vh'])?></td>
                    <td style="color:#aaaaaa;"><?php echo $lang['metarassen']['bodenkampfverteidigung']?></td>
                    <td><? echo str_replace('{1}',$attribute[4]*100,$lang['metarassen']['vh'])?></td>
                    <td style="color:#aaaaaa;"><?php echo $lang['metarassen']['aeffizienz']?></td>
                    <td><? echo str_replace('{1}',$assgrad,$lang['metarassen']['vh'])?></td>
                </tr>
            </table>
        </center>

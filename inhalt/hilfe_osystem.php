...
if ($_GET["fu"]>=1) {
    ...
    <frameset framespacing="0" border="false" frameborder="0" rows="18,*,16">
        ...
        <frameset framespacing="0" border="false" frameborder="0" cols="18,*,18">
            ...
            <frame name="rahmen12" scrolling="auto" marginwidth="0" marginheight="0" noresize src="hilfe_osystem.php?fu=<?php echo $_GET["fu2"]; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>&sprache=<?php echo $_GET["sprache"]?>" target="_self">

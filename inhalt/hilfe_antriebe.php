...
if ($_GET["fu"]>=1) {
    ...
    <body text="#000000" bgcolor="#444444"  link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <table border="0" cellspacing="0" cellpadding="4" width="100%">
            <tr>
                <td colspan="5" style="font-size:18px; font-weight:bold; filter:DropShadow(color=black, offx=2, offy=2)"><center><?php echo $lang['hilfe_antriebe'][$_GET["fu"]][0]; ?></center></td>
            <tr>
            <tr>
                <td>
                    <br>
                    <center><?php echo str_replace('{1}',$lang['hilfe_antriebe'][$_GET["fu"]][1],$lang['hilfe_antriebe']['maxwarp']);?></center>
                </td>
            </tr>
            <tr>
                <td style="color:#aaaaaa;"><br><?php echo $lang['hilfe_antriebe'][$_GET["fu"]][2]; ?></td>
            </tr>
        </table>
        <?php
    ...
    <frameset framespacing="0" border="false" frameborder="0" rows="18,*,16">
        ...
        <frameset framespacing="0" border="false" frameborder="0" cols="18,*,18">
            ...
            <frame name="rahmen12" scrolling="auto" marginwidth="0" marginheight="0" noresize src="hilfe_antriebe.php?fu=<?php echo $_GET["fu2"]; ?>&uid=<?php echo $uid; ?>&sid=<?php echo $sid; ?>&sprache=<?php echo $_GET["sprache"]?>" target="_self">

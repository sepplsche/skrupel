...
$lang['hilfe'][5][1]="<br>Wird der Bau automatisiert, so versucht die Bev&ouml;lkerung jede Runde resourcenabh&auml;ngig das Maximum an Abwehr-Anlagen zu produzieren.";

$lang['hilfe']['ueberschrift'][6]='Fabriken';
$lang['hilfe']['text'][6]="Jede Fabrik produziert eine Kilotonne Vorr&auml;te pro Monat.<br><br>Die maximale Anzahl der Fabriken wird von der Gr&ouml;ss�e der Bev&ouml;lkerung bestimmt.<br><br>";
$lang['hilfe'][6][0]='Kosten pro Fabrik';
$lang['hilfe'][6][1]="<br>Wird der Bau automatisiert, so versucht die Bev&ouml;lkerung jede Runde resourcenabh&auml;ngig das Maximum an Fabriken zu bauen.";
...
$lang['hilfe']['text'][8]="Minen sch&uuml;rfen nach den 4 Rohstoffen Lemin, Baxterium, Rennurbin und Vomisaan im Planetenkern. Baxterium, Rennurbin und Vomisaan	werden zum Bau von Schiffen, Sternenbasen und Schiffskomponeten ben&ouml;tigt. Bei Lemin hingegen handelt es sich um einen fl&uuml;chtigen Treibstoff.<br><br>Die Konzentration gibt an, wieviele Minen ben&ouml;tigt werden, um eine Kilotonne des Rohstoffes pro Monat zu f&ouml;rdern.<br><br>";
$lang['hilfe'][8][0]='hochkonzentriert';
$lang['hilfe'][8][1]='konzentriert';
$lang['hilfe'][8][2]='verteilt';
$lang['hilfe'][8][3]='weit getreut';
$lang['hilfe'][8][4]='fl&uuml;chtig';
...
$lang['hilfe'][8][9]="<br>Wird der Bau automatisiert, so versucht die Bev&ouml;lkerung jede Runde resourcenabh&auml;ngig das Maximum an Minen zu bauen.";

$lang['hilfe']['ueberschrift'][9]='H&uuml;llenproduktion';
$lang['hilfe']['text'][9]="Ein fertiges Schiff setzt sich aus der Schiffsh&uuml;lle sowie den Komponenten Antriebe, energetische Waffensysteme und projektibasierende Waffensysteme zusammen. Die Schiffsh&uuml;lle bestimmt dabei die Anzahl der einzelnen Komponenten, sowie die speziellen Fertigkeiten des Schiffes.<br><br>Um eine Schiffsh&uuml;lle produzieren zu k�nnen, muss man den entsprechenden Techlevel Rumpf in der Raumbasis erreicht haben. Der ben&ouml;tigte Techlevel ist in der zweiten Spalte zu sehen, wobei die Namen der Schiffe, die aus diesem Grunde nicht produziert werden k&ouml;nnen, in grau gehalten sind. Schiffsh&uuml;llen, die aus Mangel an Rohstoffen bzw. Cantox nicht produziert werden k&ouml;nnen, erscheinen zwar ganz normal, aber der entsprechende Button zum produzieren erscheint auch hier nicht.<br><br>Die letzte Spalte \"Lager\" zeigt an, wieviel H&uuml;llen des entsprechenden Types bereits in den Lagern der Sternenbasis liegen.";
...
$lang['hilfe'][12][6]=array('Fusionsraketen','Photonentorpedos','Transformkanone','Gammabomben','Fissionstorpedos','Mun-Katapult','Quantentorpedos','Micromitgesch&uuml;tz','Singularit&auml;tswerfer','Novabomben');
...
$lang['hilfe'][16][1][3]='Hier kann man die gew&uuml;nschte Warpgeschwindigkeit definieren. Geschwindikeiten, bei denen erh&ouml;hter Leminverbrauch stattfindet, erscheinen rot.';
...
$lang['hilfe'][16][2]='Wenn man den Flugplan best&auml;tigt, f&auml;rben sich die Markierungen in der eigenen Spielerfarbe ein. Geschieht dies nicht, so konnte die Route nicht festgelegt werden und die entsprechende Meldung erscheint. Routen, deren erste Etappe schon mehr Lemin verbaucht als das Schiff in Ihren Tank hat werden nicht &uuml;bernommen. Ausserdem werden alle Flugdaten gel&ouml;scht, wenn eine Gschwindigkeit von 0 Warp angegeben wird.';
...
$lang['hilfe']['text'][26]="Das Astrophysische Labor erh&ouml;ht bei Aktivierung die Scannreichweite des Schiffes von den normalen 47 Lichtjahren auf 116 Lichtjahre.";
...
$lang['hilfe']['text'][28]="Das Erweiterte Sensorenphalanx erh&ouml;ht bei Aktivierung die Scannreichweite des Schiffen von den normalen 47 Lichtjahren auf 85 Lichtjahre.";
